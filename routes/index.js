...
var event2 = {myEventName: 'event2', description: 'test event 2', location: {lat: 53.372417, lng: -1.504116}, startDate: new Date(2019,2,15), endDate: new Date(2019,5,20), keyword: 'key2', author: 'user1'};
var events = [];
events[0] = event1;
events[1] = event2;
